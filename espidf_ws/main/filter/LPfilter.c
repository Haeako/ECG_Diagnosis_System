...
float LPfilter_coefficients[10] = 
{
// Scaled for floating point

    0.11024641707542467, 0.22049283415084933, 0.11024641707542467, 0.9612453444136209, -0.2548166794342573,// b0, b1, b2, a1, a2
    0.0625, 0.125, 0.0625, 1.229621470846513, -0.605156831162516// b0, b1, b2, a1, a2
...
{
    LPfilter_executionState executionState;          // The executionState structure holds call data, minimizing stack reads and writes 
    ...
    executionState.pCoefficients = LPfilter_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
    ...
    LPfilter_filterBiquad( &executionState );		// Run biquad #0
    executionState.pInput = executionState.pOutput;         // The remaining biquads will now re-use the same output buffer.

    LPfilter_filterBiquad( &executionState );		// Run biquad #1
